namespace SCI.TAR.Workflows.TARArchivingWorkflow {
    ...
    #line 15 "D:\Projects\SCI.TAR\tar\SharePoint\SCI.TAR.Workflows\SCI.TAR.Workflows\TARArchivingWorkflow\Workflow.xaml"
    using System;
    
    #line default
    #line hidden
    
    #line 1 "D:\Projects\SCI.TAR\tar\SharePoint\SCI.TAR.Workflows\SCI.TAR.Workflows\TARArchivingWorkflow\Workflow.xaml"
    using System.Collections;
    
    #line default
    #line hidden
    
    #line 16 "D:\Projects\SCI.TAR\tar\SharePoint\SCI.TAR.Workflows\SCI.TAR.Workflows\TARArchivingWorkflow\Workflow.xaml"
    using System.Collections.Generic;
    
    #line default
    #line hidden
    
    #line 19 "D:\Projects\SCI.TAR\tar\SharePoint\SCI.TAR.Workflows\SCI.TAR.Workflows\TARArchivingWorkflow\Workflow.xaml"
    ...
    #line 17 "D:\Projects\SCI.TAR\tar\SharePoint\SCI.TAR.Workflows\SCI.TAR.Workflows\TARArchivingWorkflow\Workflow.xaml"
    using System.Data;
    
    #line default
    #line hidden
    
    #line 18 "D:\Projects\SCI.TAR\tar\SharePoint\SCI.TAR.Workflows\SCI.TAR.Workflows\TARArchivingWorkflow\Workflow.xaml"
    using System.Text;
    
    #line default
    #line hidden
    
    #line 20 "D:\Projects\SCI.TAR\tar\SharePoint\SCI.TAR.Workflows\SCI.TAR.Workflows\TARArchivingWorkflow\Workflow.xaml"
    ...
    public partial class Workflow : System.Activities.XamlIntegration.ICompiledExpressionRoot {
        ...
        public object InvokeExpression(int expressionId, System.Collections.Generic.IList<System.Activities.LocationReference> locations, System.Activities.ActivityContext activityContext) {
            ...
            if ((expressionId == 2)) {
                ...
                return refDataContext2.GetLocation<Microsoft.Activities.DynamicValue>(refDataContext2.ValueType___Expr2Get, refDataContext2.ValueType___Expr2Set, expressionId, this.rootActivity, activityContext);
            }
            if ((expressionId == 3)) {
                System.Activities.XamlIntegration.CompiledDataContext[] cachedCompiledDataContext = Workflow_TypedDataContext2_ForReadOnly.GetCompiledDataContextCacheHelper(this.dataContextActivities, activityContext, this.rootActivity, this.forImplementation, 2);
                if ((cachedCompiledDataContext[1] == null)) {
        ...
        public object InvokeExpression(int expressionId, System.Collections.Generic.IList<System.Activities.Location> locations) {
            ...
            if ((expressionId == 2)) {
                ...
                return refDataContext2.GetLocation<Microsoft.Activities.DynamicValue>(refDataContext2.ValueType___Expr2Get, refDataContext2.ValueType___Expr2Set);
            }
            if ((expressionId == 3)) {
        ...
        public bool CanExecuteExpression(string expressionText, bool isReference, System.Collections.Generic.IList<System.Activities.LocationReference> locations, out int expressionId) {
            ...
            if (((isReference == false) 
                        && ((expressionText == "string.Format(\"{0}/_api/Lists/getByTitle(\'Currencies\')/items\", webUrl);") 
            ...
            if (((isReference == false) 
                        && ((expressionText == "restResponse.ToString().Substring(0, 250);") 
                        && (Workflow_TypedDataContext2_ForReadOnly.Validate(locations, true, 0) == true)))) {
                expressionId = 3;
                return true;
            }
        ...
        private class Workflow_TypedDataContext2 : Workflow_TypedDataContext1 {
            ...
            internal System.Linq.Expressions.Expression @__Expr0GetTree() {
                ...
                #line 56 "D:\PROJECTS\SCI.TAR\TAR\SHAREPOINT\SCI.TAR.WORKFLOWS\SCI.TAR.WORKFLOWS\TARARCHIVINGWORKFLOW\WORKFLOW.XAML"
          ...
          webUrl = value;
            ...
            internal System.Linq.Expressions.Expression @__Expr2GetTree() {
                ...
                #line 72 "D:\PROJECTS\SCI.TAR\TAR\SHAREPOINT\SCI.TAR.WORKFLOWS\SCI.TAR.WORKFLOWS\TARARCHIVINGWORKFLOW\WORKFLOW.XAML"
          ...
          restResponse;
            ...
            [System.Diagnostics.DebuggerHiddenAttribute()]
            public void @__Expr2Set(Microsoft.Activities.DynamicValue value) {
          ...
          restResponse = value;
            ...
            public void ValueType___Expr2Set(Microsoft.Activities.DynamicValue value) {
                this.GetValueTypeValues();
            ...
            protected override void GetValueTypeValues() {
                this.currId = ((int)(this.GetVariableValue((2 + locationsOffset))));
                base.GetValueTypeValues();
            }
            
            protected override void SetValueTypeValues() {
                this.SetVariableValue((2 + locationsOffset), this.currId);
            ...
            public new static bool Validate(System.Collections.Generic.IList<System.Activities.LocationReference> locationReferences, bool validateLocationCount, int offset) {
                ...
                if (((locationReferences[(offset + 2)].Name != "currId") 
        ...
        private class Workflow_TypedDataContext2_ForReadOnly : Workflow_TypedDataContext1_ForReadOnly {
            ...
            internal System.Linq.Expressions.Expression @__Expr1GetTree() {
                ...
                #line 77 "D:\PROJECTS\SCI.TAR\TAR\SHAREPOINT\SCI.TAR.WORKFLOWS\SCI.TAR.WORKFLOWS\TARARCHIVINGWORKFLOW\WORKFLOW.XAML"
                System.Linq.Expressions.Expression<System.Func<string>> expression = () => 
          string.Format("{0}/_api/Lists/getByTitle('Currencies')/items", webUrl);;
          ...
          string.Format("{0}/_api/Lists/getByTitle('Currencies')/items", webUrl);;
            ...
            internal System.Linq.Expressions.Expression @__Expr3GetTree() {
                ...
                #line 84 "D:\PROJECTS\SCI.TAR\TAR\SHAREPOINT\SCI.TAR.WORKFLOWS\SCI.TAR.WORKFLOWS\TARARCHIVINGWORKFLOW\WORKFLOW.XAML"
                System.Linq.Expressions.Expression<System.Func<string>> expression = () => 
          restResponse.ToString().Substring(0, 250);;
